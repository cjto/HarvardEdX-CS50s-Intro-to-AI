...
class CrosswordCreator():
    ...
    def revise(self, x, y):
        ...
        for xvar in set(self.domains[x]):
            remove = True
    ...
    def consistent(self, assignment):
        ...
        for var in assignment:
            ...
            #checks correct length for every variable
            if len(assignment[var]) != var.length:
                return False

            #checks that constraints on neighbors
            ...
            #checks for multiplitives
            if assignment[var] not in checkMultiples:
                checkMultiples.add(assignment[var])
            else:
                return False

        #constaints check out
        return True
