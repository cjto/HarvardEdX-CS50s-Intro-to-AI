...
knowledge2 = And(
    And(
        And(Or(AKnight, AKnave), Not(And(AKnight, AKnave))),And(Or(BKnight, BKnave), Not(And(BKnight, BKnave)))
    ),
...
knowledge3 = And(
    And(
        ...
        And(Not(And(AKnight,AKnave)),Not(And(AKnave,AKnight)),),
        And(Not(And(BKnight,BKnave)),Not(And(BKnave,BKnight)),),
        And(Not(And(CKnight,CKnave)),Not(And(CKnave,CKnight)))
    ),
